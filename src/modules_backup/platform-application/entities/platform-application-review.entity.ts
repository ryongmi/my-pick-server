...
export class PlatformApplicationReviewEntity {
  ...
  reasons?: RejectionReason[] | null; // 표준화된 거부 사유들 (다중 선택 가능)

  @Column({ type: 'text', nullable: true })
  customReason?: string | null; // 기타 사유일 때의 상세 설명

  @Column({ type: 'text', nullable: true })
  comment?: string | null; // 관리자 코멘트

  @Column('simple-array', { nullable: true })
  requirements?: string[] | null; // 추가 요구사항

  @Column({ type: 'text', nullable: true })
  reason?: string | null; // 기존 호환성을 위한 필드
